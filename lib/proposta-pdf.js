...
import * as FONTES from './fonts-data';
...
export async function buildPropostaPdf(p) {
  ...
  doc.registerFont('fr600', FONTES.fr600);
  doc.registerFont('fr400', FONTES.fr400);
  doc.registerFont('it400', FONTES.it400);
  doc.registerFont('it500', FONTES.it500);
  doc.registerFont('it600', FONTES.it600);
